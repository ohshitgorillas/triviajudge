...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("The parser was scored in round 2 and rejected", REFUSED),
        ("Round 4 was the longest", REFUSED),
        ("Round 1 lists every question the plan leaves open", PASSED),
        ("Findings are listed in full in round 1", PASSED),
        ("No finding is dropped; round 1 reads the plan", PASSED),
        ("Round 3 is required before a cut", PASSED),
        ("Round 2 findings need a named repair", PASSED),
        ("Phase 1 reads the plan", PASSED),
    ...
    ids=[
        ...
        "regular past verb after round refused",
        "was after round refused",
        "present verb after round passed",
        "past participle before round passed",
        "past verb in an earlier clause passed",
        "present passive after round passed",
        "need and a named adjective after round passed",
        "present verb after phase passed",

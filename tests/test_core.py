...
# --- behavior 5: the root is the tree the cwd sits in, or a refusal ----------
...
# --- behavior 6: a calibration record is one line, addressed as the judge sees it ---
...
# --- behavior 7: a flag naming no line is still printed -----------------------
...
# --- behavior 8: a Stop payload that is not JSON is not a second run ---------
